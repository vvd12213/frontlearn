...
CREATE TABLE `users` (
   ...
   race                          int default 1,                               /* раса (добавлено в 10 уроке)*/                           
   culture_points                bigint DEFAULT 0,                            /*единицы культуры (доб. 7 урок)*/  
  PRIMARY KEY  (`usr_id`)
) ENGINE=MyISAM DEFAULT CHARSET=cp1251;


/*это будет NPC-игрок природа (для оазисов)*/
insert into users (usr_id,nick,pass,race ) values (1,'Свободный оазис','1234',10);
/**/
...
CREATE TABLE `fields` (
   ...
   fid_name                      char(50),                                      /*Название деревни*/  
   xcoord                        int,
   ycoord                        int,
...
update fields set usr_id = 100, fid_name='testtown' where fid = 49;
update fields set usr_id = 101, fid_name='supertown' where fid = 67;
-- назначим оазис!
...
CREATE TABLE `res_fields_types` (
   ...
   rft_sm_image                   char(30),
  PRIMARY KEY  (`rft_id`)
) ENGINE=MyISAM DEFAULT CHARSET=cp1251;


 insert into res_fields_types (rft_id, rft_name, rft_image, rft_description,rft_sm_image) values (1,'Ферма','img/res/r_grain.png','На фермах выращивают зерно для обеспечения продовольствием населения. С развитием фермы увеличивается ее производительность.','img/res/4.gif');
 insert into res_fields_types (rft_id, rft_name, rft_image, rft_description,rft_sm_image) values (2,'Железный рудник','img/res/r_ore.png','На железных рудниках шахтеры добывают ценное сырье – железо. С развитием рудника увеличивается его производительность.','img/res/3.gif');
 insert into res_fields_types (rft_id, rft_name, rft_image, rft_description,rft_sm_image) values (3,'Лесопилка','img/res/r_wood.png',' На лесопилке идет производство древесины. С увеличением уровня развития здания увеличивается его производительность.','img/res/1.gif');
 insert into res_fields_types (rft_id, rft_name, rft_image, rft_description,rft_sm_image) values (4,'Глиняный карьер','img/res/r_clay.png','На глиняном карьере добывают сырье глину. С развитием глиняного карьера увеличивается его производительность.','img/res/2.gif');
...
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (9,'Кузница доспехов','img/vill/g13.gif','img/vill/g13b.gif','В плавильных печах кузницы можно улучшить характеристики доспехов воинов. С развитием этого здания повышается максимальный уровень совершенствования доспехов.',22,'tpl_g13');
/*пункт сбора*/
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
...
BEGIN
  ...
  insert into `buildings` (bnum,bt_id,b_xcoord,b_ycoord,b_level,fid) VALUES (1,2,255,139,3,p_fid);
  ...
  insert into `buildings` (bnum,bt_id,b_xcoord,b_ycoord,b_level,fid) VALUES (12,14,298,314,1,p_fid);
  ...
  insert into `buildings` (bnum,bt_id,b_xcoord,b_ycoord,b_level,fid) VALUES (20,1,176,161,1,p_fid);  


END;                 

CALL makebuildplaces(49);  /* для нашего игрока "test" */
CALL makebuildplaces(67);  /* для второго игрока  */
...
/*для казармы*/
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (1,'Легионер','img/army/1.gif',40,35,50,120,100,150,30,6,50,1,'0:00:20',5,'Легионеры — простая и универсальная пехота римлян. Боевые единицы этого вида войск многосторонне развиты: они хорошо проявляют себя как в атаке, так и в защите. Но, всё же, их основное предназначение — защита поселений Римской Империи от конных отрядов противника.',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (2,'Преторианец','img/army/2.gif',30,65,35,100,130,160,70,5,20,1,'0:29:20',5,'Преторианцы проходят продолжительное обучение навыкам ведения обороны для дальнейшей службы при Сенате в качестве лейб-гвардии. Свою легендарную славу они заслужили благодаря отменному умению ведения ближнего боя против вражеской пехоты. Однако, преторианцы не столь умелые и сильные в обороне против кавалерии, как их братья по оружию — легионеры.',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (3,'Империанец','img/army/3.gif',70,40,25,150,160,210,80,7,50,1,'0:32:00',5,'Империанцы — единица атакующих войск Рима. Они быстры и сильны в атаке, чем наводит ужас на защитные отряды противника. Однако, за всё нужно платить — обучение империанцев довольно длительно и обходится дорого.',1);
/*для конюшни*/
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (4,'Конный разведчик','img/army/4.gif',0,20,10,20,140,160,40,7,0,2,'0:22:40',6,'Конные разведчики — разведывательная единица Рима. Очень быстрые солдаты. Они незаметно проникают во вражескую деревню и получают нужные сведения о вражеских войсках, обороне и количестве ресурсов. Если в деревне противника нет разведчиков, то разведывательная операция остается не раскрытой.',2);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (5,'Конница императора','img/army/5.gif',120,65,50,550,440,320,100,14,100,3,'0:44:00',6,'Это стандартная кавалерия римлян, подходит для набегов и внезапных быстрых атак. Отряды конницы императора не так стремительны, как галльские громы, но сильны в нападении и защите, чем наводят ужас на неподготовленного противника. Однако, нужно иметь в виду, что содержание лошади и всадника обходится недешево!',2);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (6,'Конница Цезаря','img/army/6.gif',180,80,105,800,550,640,180,10,70,4,'0:58:40',6,'Конница Цезаря — это элитные войска римлян. Необыкновенно сильны как в атаке, так и в защите, и при появлении конницы Цезаря на горизонте у всех врагов начинается паника. Их обучение, как и содержание, имеет очень высокую цену.',2);
/**/
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (7,'Таран','img/army/7.gif',60,30,75,900,360,500,70,4,0,3,'1:16:40',0,'Тараны являются тяжелым орудием для поддержки пехоты и кавалерии. Их задачей является разрушение вражеской стены, изгороди или земляного вала и, тем самым, облегчает непосредственные задачи пехоты и кавалерии.Тараны не стоит пускать в атаку без поддержки других войск, так как сами по себе они слабы.',0);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (8,'Огненная катапульта','img/army/8.gif',75,60,75,900,360,500,70,4,0,3,'1:16:40',0,'Огненные катапульты — замечательные орудия дальнего боя, разрушающие постройки и ресурсные поля. Сама по себе огненная катапульта беспомощна, поэтому ей необходимо сопровождение охраны.С развитием Пункта сбора увеличивается точность.',0);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (9,'Сенатор','img/army/9.gif',50,40,30,30750,27200,45000,37500,4,0,5,'25:11:40',0,'Сенатор — это выбранный предводитель народа. Он хороший оратор и это позволяет ему быстро убедить население деревни противника примкнуть к вашей империи.Чем чаще сенатор говорит с населением вражеского города, тем меньше оно одобряет действия своего правителя.',0);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (10,'Поселенец','img/army/10.gif',0,80,80,5800,5300,7200,5500,5,3000,1,'7:28:20',0,'Поселенцы — это смелые и отважные жители вашего города, которые, после длительного обучения, отправляются в путь для основания новой деревни.Так как путешествие и основание деревни довольно тяжело осуществить одному, поселенцы собираются группой из трёх человек. Для основания поселения им требуется по 750 единиц каждого вида сырья.',0);

insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (11,'Герой','img/army/11.gif',0,0,0,0,0,0,0,5,0,5,'0:0:00',0,'Герой',0);

/* в 10 уроке добавим типы войск природы и тип героя! */

insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (101,'Крыса','img/army/31.gif',10,25,20,0,0,0,0,0,0,1,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (102,'Паук','img/army/32.gif',20,35,40,0,0,0,0,0,0,1,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (103,'Змея','img/army/33.gif',60,40,60,0,0,0,0,0,0,1,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (104,'Летучая мышь','img/army/34.gif',80,66,50,0,0,0,0,0,0,1,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (105,'Кабан','img/army/35.gif',50,70,33,0,0,0,0,0,0,2,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (106,'Волк','img/army/36.gif',100,80,70,0,0,0,0,0,0,2,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (107,'Медведь','img/army/37.gif',250,140,20,0,0,0,0,0,0,3,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (108,'Крокодил','img/army/38.gif',450,380,240,0,0,0,0,0,0,3,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (109,'Тигр','img/army/39.gif',200,170,250,0,0,0,0,0,0,3,'0:00:00',0,'',1);
insert into spr_army(sa_id,sa_name,sa_image,sa_attack,sa_inf_defence,sa_cav_defence,sa_wood,sa_clay,sa_ore,sa_grain,sa_speed,sa_capacity,sa_cons,sa_training_time,bt_id,sa_description,sa_type) 
             values (110,'Слон','img/army/40.gif',600,440,520,0,0,0,0,0,0,5,'0:00:00',0,'',1);
...
CREATE TABLE `job_traders_move` (
   ...
   jtm_hash                       char(50),
   jtm_wood                       INT,                                            /* ресурсы, переносимые торговцами */
   jtm_clay                       INT,
   jtm_ore                        INT, 
   jtm_grain                      INT,
...
CREATE TABLE `job_army_move` (
   ...
   qty9                           int default 0,                                            /* ... */
   qty10                          int default 0,                                            /* ... */
   qty11                          int default 0,                                            /* место для героя! */
  PRIMARY KEY  (`jam_id`) 
) ENGINE=MyISAM DEFAULT CHARSET=cp1251;
...
-- insert into heroes(fid,sa_id,sa_attack,sa_inf_defence,sa_cav_defence) values (49,5,120,65,50);

         /*----------- Таблица опыта героев до 5 уровня ----------------*/
/* -- опыт - это кол-во убитых умноженное на их потребление -- sa_cons из таблицы spr_army */
CREATE TABLE `hero_exp` (
   he_id                          bigint(20) unsigned NOT NULL auto_increment,    /*ID*/
   he_level                       int,                                            /* уровень героя */  
   he_exp                         int,                                  /* текущий опыт, за убитых врагов */ 
  PRIMARY KEY  (`he_id`) 
) ENGINE=MyISAM DEFAULT CHARSET=cp1251;

insert into hero_exp(he_level,he_exp )  values (0,0);
insert into hero_exp(he_level,he_exp )  values (1,100);
insert into hero_exp(he_level,he_exp )  values (2,300);
insert into hero_exp(he_level,he_exp )  values (3,600);
insert into hero_exp(he_level,he_exp )  values (4,1000);
insert into hero_exp(he_level,he_exp )  values (5,5000);
