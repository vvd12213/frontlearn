...
CREATE TABLE `job_upgrade` (
   ...
   rf_id                         bigint(20) unsigned NOT NULL,                  /*ID поля из таблицы res_fields или buildings*/ 
...
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (2,'Главное здание','img/vill/g15.gif','img/vill/g15b.gif','В главном здании живут строители деревни. Чем выше уровень развития главного здания, тем быстрее ведется строительство.',20,'tpl_g15.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (3,'Амбар','img/vill/g11.gif','img/vill/g11b.gif','В амбаре хранятся излишки зерна. С развитием зернохранилища увеличивается его вместимость.',35,'tpl_g11.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (4,'Склад','img/vill/g10.gif','img/vill/g10b.gif','На складе хранится сырье: древесина, глина и железо. С развитием этого здания увеличивается его вместимость.',22,'tpl_g10.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (5,'Казарма','img/vill/g19.gif','img/vill/g19b.gif','В казарме могут быть обучены пехотные войска. С развитием казармы уменьшается время обучения солдат.',22,'tpl_g19.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (6,'Конюшня','img/vill/g20.gif','img/vill/g20b.gif','В конюшне могут быть обучены все войска кавалерии. С развитием конюшни уменьшается время обучения солдат.',22,'tpl_g20.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (7,'Академия','img/vill/g22.gif','img/vill/g22b.gif','В академии могут быть исследованы новые типы войск. С развитием академии увеличивается количество доступных для исследования типов войск.',22,'tpl_g22.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
                    values (8,'Кузница оружия','img/vill/g12.gif','img/vill/g12b.gif','В плавильной печи кузницы можно улучшить оружие воинов. С развитием этого здания повышается максимальный уровень улучшения оружия.',22,'tpl_g12.php');
insert into building_types (bt_id,bt_name,bt_image,bt_image_not_ready,bt_description,bt_ycoord_dif,bt_template) 
...
BEGIN
  /*сразу вставляем главное здание и еще несколько строений*/ 
